...
import useSuccessBillerStore from '../store/useSuccessBillerStore';
import * as FileSystem from 'expo-file-system';
import * as Print from 'expo-print';
import * as Sharing from 'expo-sharing';

const Success = ({ navigation }) => {
  const successBiller = useSuccessBillerStore((state) => state.successBiller);
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.message}>
        Congratulations! Your Subscription of <Text style={styles.amount}>₦{successBiller.amount}</Text> for <Text style={styles.recipient}>{successBiller.name}</Text> was successful.
      </Text>

      {/* <View style={styles.flex}>
        <Text style={styles.label}>Bill Plan</Text>
        <Text>:</Text>
