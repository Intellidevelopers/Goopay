...
const BillerDetails = ({ navigation }) => {
  ...
  const setSuccessBiller = useSuccessBillerStore((state) => state.setSuccessBiller);
  ...
  const onConfirm = async () => {
    ...
    navigation.navigate('BillerSuccess');
          ...
          <View style={styles.selectedBillerContainer}>
            <View style={styles.dropdown}>
              ...
              >
                ...
                <Picker.Item label="Plan A" value="plan A" />
                <Picker.Item label="Plan B" value="plan B" />
              </Picker>
            </View>
          </View>
        </View>
