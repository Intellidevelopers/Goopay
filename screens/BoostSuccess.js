...
const BoosterSuccess = ({ navigation, route }) => {
  const { amount, name } = route.params; // Access the passed parameters
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.message}>
        Congratulations! Your order of <Text style={styles.amount}>₦{formatCurrency(amount)}</Text> to <Text style={styles.recipient}>{name}</Text> was successful.
      </Text>
